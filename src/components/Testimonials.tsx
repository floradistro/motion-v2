  ...
  return (
    ...
    >
      <div className="flex items-baseline gap-3">
        <span className="text-6xl lg:text-7xl font-extralight text-white number-glow">
          {avg}
        </span>
      ...
      <div className="flex gap-8">
        <div className="text-center">
          ...
          <p className="text-[10px] text-muted/40 tracking-[0.2em] uppercase mt-1">
            Reviews
          </p>
        </div>
        <div className="text-center">
      ...
      <div className="flex gap-5 animate-marquee">
        {[...snippets, ...snippets].map((title, i) => (
          ...
          >
            ...
            <span className="text-[12px] text-muted/40 whitespace-nowrap font-light">
              &ldquo;{title}&rdquo;
            </span>
          </div>
        ))}
      ...
      >
        ...
        {review.helpful_count > 0 && (
          <div className="mt-5 pt-5 border-t border-white/[0.03] flex items-center gap-2">
            <svg
              className="w-3.5 h-3.5 text-muted/20"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={1.5}
      ...
      <button
        ...
        className={`px-5 py-2.5 text-[11px] tracking-[0.2em] uppercase font-medium border transition-all duration-300 ${
          active === FILTER_ALL
            ...
            : "bg-transparent border-white/[0.04] text-muted/35 hover:text-muted/60 hover:border-white/[0.08]"
        }`}
      >
        All ({reviews.length})
      </button>
  ...
  return (
    <section className="relative py-32 lg:py-48 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        >
          <p className="text-[13px] text-muted/25 font-light">
